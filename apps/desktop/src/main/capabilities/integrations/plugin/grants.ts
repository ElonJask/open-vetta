...
function buildOfficialDomainGrants(): CapabilityGrant[] {
	return [
		...
		createCapabilityGrant(DOMAIN_AGENT_SETTINGS_CAPABILITIES.GET_IMAGE_GENERATION),
		createCapabilityGrant(DOMAIN_AGENT_SETTINGS_CAPABILITIES.SET_IMAGE_GENERATION),
