				...
				{options.map((option, index) => (
					...
					>
						{option.type === "asset" ? (
							...
							<>
								<span className="flex size-7 shrink-0 items-center justify-center rounded-md bg-muted/70 text-foreground/70">
									<span className="icon-[lucide--text-quote] block size-4" aria-hidden="true" />
								</span>
