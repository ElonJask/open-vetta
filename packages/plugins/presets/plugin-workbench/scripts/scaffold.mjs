 ...
 * Usage: node scaffold.mjs <targetDir> --id <id> --name <displayName> [--semver-sdk ^0.3.1] [--semver-vite ^0.2.0]
 */
...
function parseArgs(argv) {
	...
	const out = { target: null, id: null, name: null, sdk: "^0.3.1", vite: "^0.2.0" };
	const rest = [...argv];
